...
// ============================================================
// § Identity 三元组类型 [Ref: CAP-BS09-C4 §2.bis, T5-BS-09 §0.2]
// ============================================================
...
// ============================================================
// § IsolationPolicy 接口 [Ref: CAP-BS09-C4 §2.bis, BP §V2.B.3, D9 SL-2]
// ============================================================

// BrowserSessionHandle — IsolationPolicy.Apply 的 session 句柄占位.
//
// Phase_v2_1: 接口型空 marker, Phase_v2_4 由 BrowserSession 实现 (e.g. 暴露 CDP target / 配置写入接口).
...
//
// Phase_v2_1: 仅 NoopPolicy stub (P0 skeleton).
// Phase_v2_4: ProxyPolicy 首例 (J3 默认值, P1 deferred).
...
// ============================================================
// § IdentityKey 工厂 [Ref: CAP-BS09-C4 §2.bis 确定性约束 + TC-09-U-38]
// ============================================================
